...
>
> This document is the authoritative behavioral specification for the Hepatitis B Surface Antigen (HBsAg) laboratory report.
>
...
|--------|-------|
| Template Code | HBSAG |
| Official Template Name | Hepatitis B (Screening) |
| Examination Family | Serology & Immunology |
| Renderer Family | SimpleResult |
| Source Word Template (historical; not in repository) | Templates/HBSAG.docx |
...
Records the qualitative screening result for Hepatitis B Surface Antigen (HBsAg).
...
Current template values are sample values only.
