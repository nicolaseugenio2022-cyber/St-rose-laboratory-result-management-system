...
export function PatientDemographicsForm({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-3.5 shadow-xs mb-4">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full px-2.5 py-1 text-xs rounded-md border border-slate-300 focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary focus:outline-none resize-none font-medium"
            />
